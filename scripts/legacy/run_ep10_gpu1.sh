#!/bin/bash
# EP10 Experiments - GPU 1 (models 38-74)
...
# Load second half of EP10 models (38-74)
MODELS=$(python3 -c "
import json
...
echo "=============================================="
echo "EP10 GPU1 - Models 38-74 (37 models)"
echo "Start: $(date)"
echo "=============================================="

for MODEL in $MODELS; do
    echo ""
    echo "[GPU1] Processing: $MODEL"
