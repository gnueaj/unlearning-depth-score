#!/usr/bin/env python3
"""
Plot UDR histograms for alpha2 experiments (30 methods)
"""
...
def plot_method_comparison_histogram():
    ...
    ax.set_title('UDR Comparison Across 30 Unlearning Methods (α=2, τ=0.05)', fontsize=14, fontweight='bold')
    ax.set_xticks(x)
...
def plot_udr_distribution_by_category():
    ...
    plt.suptitle('UDR Distribution: Method × Learning Rate (α=2, τ=0.05)', fontsize=14, fontweight='bold', y=1.02)
    plt.tight_layout()
...
def plot_combined_udr_histogram():
    ...
    ax.set_title('UDR Distribution by Method Type (α=2, τ=0.05)', fontsize=14, fontweight='bold')
    ax.set_xlim(0, 1)
...
def plot_boxplot_comparison():
    ...
    ax.set_title('UDR Distribution by Method (Boxplot, α=2, τ=0.05)', fontsize=14, fontweight='bold')
...
def print_summary_stats():
    ...
    print("\n" + "="*60)
    print("UDR Summary Statistics (α=2, τ=0.05)")
    print("="*60)
    ...
    with open(OUTPUT_DIR / "udr_summary_stats.txt", "w") as f:
        f.write("UDR Summary Statistics (α=2, τ=0.05)\n")
        f.write("="*80 + "\n\n")
...
if __name__ == "__main__":
    print("Generating UDR histograms for alpha2 experiments...")
